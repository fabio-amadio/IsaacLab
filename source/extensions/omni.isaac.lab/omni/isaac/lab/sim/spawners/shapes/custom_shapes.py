...
if TYPE_CHECKING:
    from . import custom_shapes_cfg
import random


@clone
def spawn_random_sphere(
    prim_path: str,
    cfg: custom_shapes_cfg.RandomSphereCfg,
    ...
    attributes = {"radius": cfg.nominal_radius + random.uniform(-cfg.delta_radius, cfg.delta_radius)}
