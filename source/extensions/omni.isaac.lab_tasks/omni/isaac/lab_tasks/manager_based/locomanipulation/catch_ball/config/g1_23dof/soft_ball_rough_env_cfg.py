...
from omni.isaac.lab_tasks.manager_based.locomanipulation.catch_ball.catch_soft_ball_env_cfg import (
...
class G1CatchBallRewards(G1BaseWalkRewards):
    ...
    ball_close_to_hands = RewTerm(
        func=mdp.soft_ball_close_to_hands_exp, weight=1.0, params={"std": 0.4}
    )
